...
/meeting_rooms/1/ DEL - Удаление переговорной комнаты (Только для суперюзеров)
```
Вывод:
{
  "name": "string",
...
/meeting_rooms/1/ PATCH - Чатичное обновление переговорной комнаты (Только для суперюзеров)
```
Ввод:
{
  "name": "string",
...
/meeting_rooms/1/available?date=2026-07-01 GET - Получние всех свободных временных отрезков переговорной комнаты на определенную дату (Только для авторизованных пользователей)
```
Вывод:
[
  {
...
/users/me/ GET - Вывод текущего пользователя
```
Вывод:
{
  "id": 0,
...
/users/me/ PATCH - Обновление текущего пользователя
```
Ввод:
{
  "email": "user@example.com",
...
/users/1/ GET - Вывод пользователя
```
Вывод:
{
  "id": 0,
...
/users/1/ PATCH - Обновление пользователя
```
Ввод:
{
  "email": "user@example.com",
